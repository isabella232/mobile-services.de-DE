...
>[!IMPORTANT]
>
>Die Akquise in V 3 bezieht sich auf die Akquise-Links, die Sie mit dem Akquise-Builder in der Benutzeroberfläche von Adobe Mobile Services erstellen. Um diese Funktion zu verwenden, müssen Sie für Experience Cloud-Lösungen 4.6.0 oder höher auf Android SDK 4.x aktualisieren.
...
1. Führen Sie die erforderlichen Schritte in der [Mobile App-Akquise aus](/help/android/acquisition-main/acquisition.md) und stellen `INSTALL_REFERRER`Sie sicher, dass Sie den Empfänger der Übertragung ordnungsgemäß implementiert haben.
1. In the Adobe Mobile Services UI, click  **[!UICONTROL Acquisition]** &gt; **[!UICONTROL Marketing Links Builder]** and generate an Acquisition Marketing Link URL that sets Google Play as the destination for Android devices.
   ...
   >[!TIP]
   >
   >Wenn Sie auf Android- und ios-Apps im Akquise-Link verweisen, verwenden Sie Google Play als Standardspeicher.
