...
* **Warten auf Push-Dienst**
   ...
   >
   >* **APNS**: [Qualität der Dienstleistung](https://developer.apple.com/documentation/usernotifications)
   >
   >* **GCM**: [Lebensdauer einer Nachricht](https://developers.google.com/cloud-messaging/concept-options)


## Wie kann ich mein Apple Push-Dienstzertifikat erneuern?

Für das Senden von Push-Nachrichten ist ein gültiges Push-Dienstzertifikat erforderlich. Mobile Services benachrichtigt Sie, wenn Ihr Zertifikat kurz vor dem Ablauf steht oder abgelaufen ist. Wenn diese Benachrichtigung angezeigt wird, sollten Sie die folgenden Schritte durchführen, um Ihr Zertifikat zu verlängern:
...
3. Konfigurieren und testen Sie ein neues Zertifikat.
   ...
   Weitere Informationen finden Sie unter [Voraussetzungen zum Aktivieren von Push-Nachrichten](/help/using/c-manage-app-settings/c-mob-confg-app/configure-push-messaging/prerequisites-push-messaging.md)
